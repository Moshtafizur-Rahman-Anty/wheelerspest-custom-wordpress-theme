        ...
        <div class="col-sm-12 footer_main">
            ...
            <div class="col-sm-12 footer_secondblck">
                <div class="container">
                    ...
                    <div class="col-sm-3 footer_menuservice">
                        <h2>SERVICES</h2>
                        <ul>
                            <li>
                    ...
                    <div class="col-sm-3 footer_menu contact_detail">
                        <h2>CONTACT US!</h2>
            ...
            <div class="col-sm-12 footer_third_blck">
                <div class="container">
...
<script>
    var base_url = "https://wheelerspestcontrol.com/";
    var slug = "";
</script>
<script src="https://wheelerspestcontrol.com/assets/js/frontend/jquery.min.js"></script>
<script src="https://wheelerspestcontrol.com/assets/js/frontend/bootstrap.min.js"></script>
<!-- <script src=""></script> -->
<script src="https://wheelerspestcontrol.com/assets/js/frontend/slick.min.js"></script>
<!-- <script>	$(document).ready(function(){	$("body").addClass("slick_load");	$(window).scroll(function(){	if($("body").hasClass('slick_load')){	var slick = '<script src=""><\/script>';	$('footer').append(slick);	var custom_slick = '<script src=""><\/script>';	$('footer').append(custom_slick);	$("body").removeClass("slick_load");	}	});	}); </script> -->
<script src="https://wheelerspestcontrol.com/assets/js/frontend/lazyload_js_css.js"></script>
<!-- <script src=""></script> <script src=""></script> -->
<script src="https://wheelerspestcontrol.com/assets/js/frontend/custom.js"></script>
<script>
    $(function() {
        AOS.init({
            once: true,
...
<!-- Google tag (gtag.js) -->
<!-- <script async src="https://www.googletagmanager.com/gtag/js?id=G-586R1D278D"></script> -->
<script>
    $(document).ready(function() {
        setTimeout(function() {
            $('footer').append('<script async src="https://www.googletagmanager.com/gtag/js?id=G-586R1D278D"><\/script>')
        }, 15000);
    });
</script>
<script>
